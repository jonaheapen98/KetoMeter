...
export default function CameraScreen({ navigation }) {
  ...
  const proceedToPreview = () => {
    if (capturedImages.length === 0) {
      Alert.alert('No Images', 'Please take or select at least one photo');
      return;
    }
    
    navigation.navigate('ImagePreview', { images: capturedImages });
  };
      ...
      <View style={styles.permissionContainer}>
        ...
        <View style={styles.permissionContent}>
          ...
          <Text style={styles.permissionDescription}>
            To snap photos of your food and nutrition labels, we need access to your camera. This helps us provide accurate keto analysis.
          </Text>
          ...
          <View style={styles.permissionFeatures}>
            <View style={styles.permissionFeature}>
              ...
              <Text style={styles.permissionFeatureText}>Take up to 3 photos</Text>
            </View>
            <View style={styles.permissionFeature}>
              <Feather name="check" size={20} color="#4CAF50" />
            ...
            <View style={styles.permissionFeature}>
              <Feather name="check" size={20} color="#4CAF50" />
              <Text style={styles.permissionFeatureText}>Get instant keto analysis</Text>
            </View>
          </View>
        </View>
